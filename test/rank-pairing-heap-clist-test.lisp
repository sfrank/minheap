(defpackage :rank-pairing-heap-clist-test (:use :CL :rank-pairing-heap-clist :lisp-unit))

(in-package :rank-pairing-heap-clist-test)

(define-test test-basic
  (let ((heap (make-instance 'rank-pairing-heap-clist:rank-pairing-heap-clist))
...
(define-test test-meld
  (let ((heap-1 (make-instance 'rank-pairing-heap-clist:rank-pairing-heap-clist))
        (heap-2 (make-instance 'rank-pairing-heap-clist:rank-pairing-heap-clist)))
